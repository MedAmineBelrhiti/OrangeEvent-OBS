...
import event.obs.service.EntiteService;
...
/**
 * Provides the base implementation for the entite remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link event.obs.service.impl.EntiteServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see event.obs.service.impl.EntiteServiceImpl
 * @generated
 */
public abstract class EntiteServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EntiteService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EntiteService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EntiteServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EntiteService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		entiteService = (EntiteService)aopProxy;

		_setServiceUtilService(entiteService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return EntiteService.class.getName();
	}
	...
	private void _setServiceUtilService(EntiteService entiteService) {
		try {
			Field field = EntiteServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, entiteService);
		}
	...
	@Reference
	protected event.obs.service.EntiteLocalService entiteLocalService;
