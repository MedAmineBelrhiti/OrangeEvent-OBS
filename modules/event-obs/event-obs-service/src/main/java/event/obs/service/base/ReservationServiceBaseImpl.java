...
import event.obs.service.ReservationService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link event.obs.service.impl.ReservationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see event.obs.service.impl.ReservationServiceImpl
 * @generated
 */
public abstract class ReservationServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ReservationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ReservationServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setServiceUtilService(reservationService);
	}
	...
	private void _setServiceUtilService(ReservationService reservationService) {
		try {
			Field field = ReservationServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, reservationService);
		}
	...
	@Reference
	protected event.obs.service.ReservationLocalService reservationLocalService;
