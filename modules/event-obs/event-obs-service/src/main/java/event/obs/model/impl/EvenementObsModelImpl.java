...
import event.obs.model.EvenementObsModel;
...
public class EvenementObsModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"titre", Types.VARCHAR}, {"startDate", Types.TIMESTAMP},
		{"endDate", Types.TIMESTAMP}, {"lieu", Types.VARCHAR},
		{"description", Types.VARCHAR}, {"votingEndDate", Types.TIMESTAMP},
		{"nbrUserMax", Types.INTEGER}, {"nbrUserConfirmed", Types.INTEGER},
		{"managerName", Types.VARCHAR}, {"entityName", Types.VARCHAR}
	};
	...
	public static final String TABLE_SQL_CREATE =
		"create table OBS_EvenementObs (uuid_ VARCHAR(75) null,idEvent LONG not null primary key,groupId LONG,companyId LONG,createDate DATE null,modifiedDate DATE null,titre VARCHAR(75) null,startDate DATE null,endDate DATE null,lieu VARCHAR(75) null,description VARCHAR(75) null,votingEndDate DATE null,nbrUserMax INTEGER,nbrUserConfirmed INTEGER,managerName VARCHAR(75) null,entityName VARCHAR(75) null)";
	 ...
	 */
	@Deprecated
	public static final long IDEVENT_COLUMN_BITMASK = 16L;
	...
	static {
		...
		attributeGetterFunctions.put("titre", EvenementObs::getTitre);
		attributeSetterBiConsumers.put(
			"titre", (BiConsumer<EvenementObs, String>)EvenementObs::setTitre);
		...
		attributeGetterFunctions.put("entityName", EvenementObs::getEntityName);
		attributeSetterBiConsumers.put(
			"entityName",
			(BiConsumer<EvenementObs, String>)EvenementObs::setEntityName);
	...
	public String getOriginalEntityName() {
		return getColumnOriginalValue("entityName");
	}
	...
	public Object clone() {
		...
		evenementObsImpl.setTitre(getTitre());
		...
		evenementObsImpl.setEntityName(getEntityName());
	...
	public EvenementObs cloneWithOriginalValues() {
		...
		evenementObsImpl.setTitre(this.<String>getColumnOriginalValue("titre"));
	...
	public CacheModel<EvenementObs> toCacheModel() {
		...
		evenementObsCacheModel.titre = getTitre();

		String titre = evenementObsCacheModel.titre;

		if ((titre != null) && (titre.length() == 0)) {
			evenementObsCacheModel.titre = null;
		}
		...
		evenementObsCacheModel.entityName = getEntityName();

		String entityName = evenementObsCacheModel.entityName;

		if ((entityName != null) && (entityName.length() == 0)) {
			evenementObsCacheModel.entityName = null;
		}
	...
	static {
		...
		columnBitmasks.put("titre", 64L);

		columnBitmasks.put("startDate", 128L);

		columnBitmasks.put("endDate", 256L);

		columnBitmasks.put("lieu", 512L);

		columnBitmasks.put("description", 1024L);

		columnBitmasks.put("votingEndDate", 2048L);

		columnBitmasks.put("nbrUserMax", 4096L);

		columnBitmasks.put("nbrUserConfirmed", 8192L);

		columnBitmasks.put("managerName", 16384L);

		columnBitmasks.put("entityName", 32768L);
