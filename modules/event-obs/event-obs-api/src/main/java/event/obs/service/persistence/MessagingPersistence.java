...
import event.obs.exception.NoSuchMessagingException;
import event.obs.model.Messaging;

import org.osgi.annotation.versioning.ProviderType;

/**
 * The persistence interface for the messaging service.
 *
 * <p>
 ...
 */
@ProviderType
public interface MessagingPersistence extends BasePersistence<Messaging> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MessagingUtil} to access the messaging persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<Messaging> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<Messaging> findByUuid(
	...
	public java.util.List<Messaging> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Messaging>
			orderByComparator);
	 ...
	 * @return the matching messagings
	 */
	public java.util.List<Messaging> findByUuid_C(String uuid, long companyId);
	 ...
	 * @return the range of matching messagings
	 */
	public java.util.List<Messaging> findByUuid_C(
	 ...
	 */
	public void cacheResult(java.util.List<Messaging> messagings);
	 ...
	 */
	public java.util.List<Messaging> findAll();
	 ...
	 */
	public java.util.List<Messaging> findAll(int start, int end);
