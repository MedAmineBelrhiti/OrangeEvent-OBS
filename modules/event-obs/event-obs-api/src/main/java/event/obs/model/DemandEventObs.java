 ...
 * @generated
 */
@ImplementationClassName("event.obs.model.impl.DemandEventObsImpl")
@ProviderType
public interface DemandEventObs extends DemandEventObsModel, PersistedModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>event.obs.model.impl.DemandEventObsImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
