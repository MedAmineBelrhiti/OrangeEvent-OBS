 ...
 * @generated
 */
@ImplementationClassName("event.obs.model.impl.TransportImpl")
@ProviderType
public interface Transport extends PersistedModel, TransportModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>event.obs.model.impl.TransportImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
