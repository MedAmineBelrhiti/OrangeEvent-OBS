...
package event.obs.service.persistence.impl.constants;

/**
 * @author Brian Wing Shun Chan
 * @generated
 */
public class OBSPersistenceConstants {

	public static final String BUNDLE_SYMBOLIC_NAME = "event.obs.service";
