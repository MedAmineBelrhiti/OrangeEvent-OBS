...
/**
 * Provides the local service interface for ContactSupport. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ContactSupportLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ContactSupportLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>event.obs.service.impl.ContactSupportLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the contact support local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ContactSupportLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ContactSupport addReclamataion(
